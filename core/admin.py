...
class CustomAdminSite(admin.AdminSite):
    ...
    def get_urls(self):
        ...
        custom_urls = [
            ...
            path('uploader/', self.admin_view(self.uploader_view), name='uploader'),
        ]
        return custom_urls + urls
    
    def uploader_view(self,request):
        ...
        return TemplateResponse(request, "admin/uploader.html", context)
